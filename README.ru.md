...
Научно-технический Golang-бот прогноза условий для астрономии в Telegram и VK.
...
Актуальные production-контракты: `surface-hourly-v17`, `cloud-hourly-v4`
(187 GRIB-сообщений на час) и `point-v6-native-cloud-mass-mh`.

## Документация

- [KISS-архитектура](docs/architecture.ru.md)
- [Расчёт и перепроверка Overall Astronomy Index](docs/research-overall-index.ru.md)
- [Текущий статус реализации](docs/implementation-status.ru.md)
- [Результаты server-side проверки источников](docs/data-source-spike.ru.md)
- [Научный статус и воспроизводимость](docs/scientific-method.ru.md)
