...
параметры управляют доступом или калибровкой и являются необязательными.
Назначение и рекомендуемые значения приведены в
[полном справочнике `.env`](docs/configuration.ru.md).
