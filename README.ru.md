...
Этот отдельный анализ ICON-EU сравнивает восемь направлений на 72 нативных часовых интервалах `f001..f072`. Каждое направление с видимой высотой 10 градусов использует полное рефракционное и физическое ядро астрокупола. HHL означает поверхность атмосферной модели, а не измеренный местный горизонт.
...
нативных часовых интервалов `f001..f072` при фиксированной видимой высоте
`10°`. Расчёт использует то же полно-рефракционное ядро, что и астрокупол;
ICON HHL служит только нижней границей атмосферной модели, а не фактическим
