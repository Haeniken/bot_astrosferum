...
Ниже показан реальный русскоязычный результат для Санкт-Петербурга из ICON-EU run `2026072206 UTC`. Это датированный воспроизводимый пример, а не актуальный прогноз. Обложка выше является художественной иллюстрацией и не кодирует измерения.

### 1/7 · Почасовая погода и астрономические события

![Почасовая погода для Санкт-Петербурга](docs/assets/examples/saint-petersburg/ru/weather-hourly.png)

### 2/7 · Overall Astronomy Index

![Overall Astronomy Index для Санкт-Петербурга](docs/assets/examples/saint-petersburg/ru/overall-astronomy-index-hourly.png)
...
![Тепловая карта эффективной облачной преграды для Санкт-Петербурга](docs/assets/examples/saint-petersburg/ru/cloud-obstruction-height-hourly.png)
...
![Тепловая карта скорости ветра для Санкт-Петербурга](docs/assets/examples/saint-petersburg/ru/wind-speed.png)
...
![Тепловая карта векторного сдвига ветра для Санкт-Петербурга](docs/assets/examples/saint-petersburg/ru/wind-vector-shear.png)
...
![Тепловая карта изменения направления ветра для Санкт-Петербурга](docs/assets/examples/saint-petersburg/ru/wind-direction-delta.png)
...
![Прогнозный индекс сиинга по ветру для Санкт-Петербурга](docs/assets/examples/saint-petersburg/ru/forecast-seeing-index.png)
...
HTTPS-доступ к DWD, Telegram и настроенным источникам атласов; входящий порт
для Telegram long polling не нужен.
